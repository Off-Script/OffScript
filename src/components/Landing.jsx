        ...
        <div className="container">
          <div className="parallax-container highlight valign-wrapper">
            <div className="container">
              ...
              <div className="cyan-text flow-text"><b>Write a speech, upload a document from your computer, or practice from our free and open Library of famous works. We'll listen to you, track your accuracy, and show you what sections to work on.</b></div>
            </div>
          ...
          <div className="parallax-container highlight valign-wrapper">
            <div className="container">
              <h3 className="valign white-text">Go OffScript</h3>
                <div className="white-text flow-text"><b>Sometimes an unscripted moment can make your speech shine. With tone analytics from Watson, you can compare your performance to your original script and make changes as you improvise.</b></div>
            </div>
        ...
        <div className="container">
          <div className="parallax-container highlight valign-wrapper">
            <div className="container">
              ...
              <div className="black-text flow-text"><b>Practice makes perfect. With a free OffScript account, you'll be ready to edit and save your scripts so you can track your improvement over time.</b></div>
